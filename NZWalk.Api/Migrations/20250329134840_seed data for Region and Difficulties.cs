    ...
    public partial class seeddataforRegionandDifficulties : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("453e8fb5-42a0-4cc7-aaf1-84bc416432a0"), "Easy" },
                    { new Guid("9d2fd3b2-495f-4082-857f-141bad2462bb"), "Medium" },
                    { new Guid("a93c97a4-0072-45ec-974a-2657d7316b59"), "Hard" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("453e8fb5-42a0-4cc7-aaf1-84bc416432a0"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("9d2fd3b2-495f-4082-857f-141bad2462bb"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("a93c97a4-0072-45ec-974a-2657d7316b59"));
